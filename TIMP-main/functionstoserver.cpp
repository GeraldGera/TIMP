...
// ��������� �������, ������� �� �������� � main.cpp
extern bool checkEgeAnswer(int task_num, const std::string& user_answer);
...
QString submitAnswer(long socketDesc, int taskId, const QString &answer){
    // ПРОВЕРКА ДЛЯ ЗАДАЧ ЕГЭ (24, 25, 26, 27)
    if (taskId == 24 || taskId == 25 || taskId == 26 || taskId == 27) {
        bool correct = checkEgeAnswer(taskId, answer.toStdString());
        if (correct) {
