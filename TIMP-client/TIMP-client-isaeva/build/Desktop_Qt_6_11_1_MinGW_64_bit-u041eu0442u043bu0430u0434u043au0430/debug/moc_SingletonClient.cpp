...
void SingletonClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->messageFromServer((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SingletonClient::*)(const QString & )>(_a, &SingletonClient::messageFromServer, 0))
            return;
    }
}
...
// SIGNAL 0
void SingletonClient::messageFromServer(const QString & _t1)
{
